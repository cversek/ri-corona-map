...
cov<-read.csv("datasets/covid_2020-04-14.csv",header=T, stringsAsFactors = F)
#all "<5" temp set to 3
...
plot.call<-c("plot(RI,col=RI$col,main='RI COVID-19 Cases by Town',cex.main=2,xlab='April 14, 2020',cex.lab=3)")
